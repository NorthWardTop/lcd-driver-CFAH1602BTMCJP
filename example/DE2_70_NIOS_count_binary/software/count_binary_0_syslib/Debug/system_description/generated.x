 ...
 *
 * Generated: 2008-10-21 15:18:50.968
 *
 */
...
MEMORY
{
    ...
    onchip_mem_UNUSED : ORIGIN = 0x09602000, LENGTH = 32
    onchip_mem : ORIGIN = 0x09602020, LENGTH = 8160
    sdram_u1 : ORIGIN = 0x04000020, LENGTH = 33554400
    sdram_u2 : ORIGIN = 0x06000000, LENGTH = 33554432
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_mem = 0x09602000 ;
...
SECTIONS
{
    ...
    .sdram_u1 LOADADDR (.onchip_mem) + SIZEOF (.onchip_mem): AT (LOADADDR (.onchip_mem) + SIZEOF (.onchip_mem))
    {
    ...
    .sdram_u2 : AT (LOADADDR (.sdram_u1) + SIZEOF (.sdram_u1))
    {
